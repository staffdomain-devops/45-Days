...
@retry(**RETRY_KWARGS)
def _fetch_crm_associations(contact_id, hubspot_key):
...
def fetch_crm_meetings(client, contact_id, since, hubspot_key):
    data = _fetch_crm_associations(contact_id, hubspot_key)
...
if __name__ == "__main__":
    ...
    try:
        ...
        write_dlq(contact_id, contact_email, "fetch_hubspot", exc)
        raise
